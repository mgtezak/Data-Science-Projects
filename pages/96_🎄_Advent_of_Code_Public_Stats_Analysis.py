...
st.write('''
    - **Uploading the Data to Kaggle:**
        ...
        - One can also find the [kaggle notebook](https://www.kaggle.com/code/michaeltezak/visualizing-advent-of-code-public-stats) which I used to create all the plots
